...
with right_col:
    # Reference values (Dashboard.js): panel padding 20px, border-radius 12px,
    # gap inside panel 12px (alerts), between panels 25px.
    CARD_GAP = "12px"
    PANEL = (
    ...
    # ── Port rows — Quick Actions style from reference ───────────────────
    # Reference: padding 12px, border 1px solid #eee, bg #f8f9fa, radius 8px
    # Dark adaptation: bg #0d1117, border #263044, left-border 4px solid color
    port_rows = []
    ...
    # ── Alert / news cards — Live Alerts style from reference ────────────
    # Reference: border-left 4px solid color, tinted bg, radius 8px, padding 12px
    # Title 14px/700, desc 13px, timestamp 11px — all with distinct colors per severity
    alert_cards = []
